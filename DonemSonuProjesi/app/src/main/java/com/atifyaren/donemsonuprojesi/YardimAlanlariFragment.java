...
import com.atifyaren.donemsonuprojesi.databinding.FragmentYardimAlanlariBinding;
public class YardimAlanlariFragment extends Fragment {

    private FragmentYardimAlanlariBinding binding;
    private String[] helpAreas;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentYardimAlanlariBinding.inflate(inflater, container, false);
